...
const gridOptions = {
    ...
    columnDefs: [
        ...
        { type: ['hideColumn', 'sumColumn', 'numericColumn'], headerName: 'Examined', field: 'TSMTIMELINE_Examined' },
        { type: ['hideColumn', 'sumColumn', 'numericColumn'], headerName: 'Affected', field: 'TSMTIMELINE_Affected' },
        { type: ['hideColumn', 'sumColumn', 'numericColumn'], headerName: 'Failed', field: 'TSMTIMELINE_Failed' },
        { type: ['hideColumn', 'sumColumn', 'numericColumn'], headerName: 'Idle', field: 'TSMTIMELINE_Idle' },
